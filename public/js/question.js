...
$(".add").on("click", function () {
  var adds = $(this).parent().clone(true);
...
for (var i = 0; i <= 7; i++) {
  var days = "<option value=\"day".concat(i, "\">").concat(i, "</option>");
  day.insertAdjacentHTML('beforeend', days);
}

for (var _i = 0; _i <= 23; _i++) {
  var times = "<option value=\"time".concat(_i, "\">").concat(_i, "</option>");
  time.insertAdjacentHTML('beforeend', times);
}

for (var _i2 = 0; _i2 <= 59; _i2++) {
  var minutes = "<option value=\"minute".concat(_i2, "\">").concat(_i2, "</option>");
...
module.exports = __webpack_require__(/*! /var/www/html/my_laravel/resources/js/question.js */"./resources/js/question.js");
